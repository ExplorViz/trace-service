package net.explorviz.trace.util;
...
public abstract class PerformanceLogger {
  ...
  public PerformanceLogger(final Logger baseLogger, String message) {
  ...
  public static PerformanceLogger newOperationPerformanceLogger(
      Logger baseLogger,
   ...
   */
  private static class OperationThresholdLogger extends PerformanceLogger {
